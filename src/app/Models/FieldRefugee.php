...
class FieldRefugee extends Pivot
{
    ...
    public static function random_fields(){
        ...
        return [
            ...
            Field::where("label", 'gender')->first()->id => ["id" => $faker->uuid, "value" => ListGender::inRandomOrder()->first()->id],
            ...
            Field::where("label", 'route')->first()->id => ["id" => $faker->uuid, "value" => ListRoute::inRandomOrder()->first()->id],
            Field::where("label", 'residence')->first()->id => ["id" => $faker->uuid, "value" => ListCountry::inRandomOrder()->first()->id],
        ];
    }
}
