    ...
    public function definition()
    {
        return [
            ...
            Field::where("label", 'nationality')->first()->id =>
                ["value" => ListCountry::inRandomOrder()->first()->id],
            ...
            Field::where("label", 'role')->first()->id =>
                ["value" => ListRole::inRandomOrder()->first()->id],
            ...
            Field::where("label", 'gender')->first()->id => ["value" => ListGender::inRandomOrder()->first()->id],
            ...
            Field::where("label", 'route')->first()->id => ["value" => ListRoute::inRandomOrder()->first()->id],
            Field::where("label", 'residence')->first()->id => ["value" => ListCountry::inRandomOrder()->first()->id],
        ];
    }
}
