<x-jet-form-section submit="updateProfileInformation">
    ...
    <x-slot name="form">
        ...
        @if (Laravel\Jetstream\Jetstream::managesProfilePhotos())
            <div x-data="{photoName: null, photoPreview: null}" class="col-span-6 sm:col-span-4">
                ...
                <x-jet-label for="photo" value="{{ __('profile/update-profile-information-form.photo') }}" />
    ...
    <!-- Name -->
        <div class="col-span-6 sm:col-span-4">
            <x-jet-label for="username" value="{{ __('profile/update-profile-information-form.name') }}" />
            <x-jet-input id="username" type="text" class="mt-1 block w-full" wire:model.defer="state.name" autocomplete="username" />
            <x-jet-input-error for="username" class="mt-2" />
        </div>

        <!-- Email -->
        <div class="col-span-6 sm:col-span-4">
            <x-jet-label for="email" value="{{ __('profile/update-profile-information-form.email') }}" />
