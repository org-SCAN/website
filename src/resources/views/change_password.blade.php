...
<div class="container">
    <form>
        ...
        <div style="text-align:center">
            ...
            <input type="text" placeholder="Write your username" id="username" name="username" required>

            <label for="pass"> New password (8 characters minimum):</label>
            <input type="password" placeholder="Write your new password" id="pass" name="password"
               minlength="8" required>

            <label for="pass"> Rewrite the new password :</label>
            <input type="password" placeholder="Rewrite your password" id="pass" name="password"
               minlength="8" required>
