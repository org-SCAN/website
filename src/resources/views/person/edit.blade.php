@section('title', __('person/edit.edit_title', ['name' => $person->best_descriptive_value]))
<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            {{ __('person/edit.edit_title', ['name' => $person->best_descriptive_value]) }}
        </h2>
    </x-slot>
        ...
        <div class="max-w-4xl mx-auto py-10 sm:px-6 lg:px-8">
            <div class="block mb-8">
                <a href="{{ route('person.index')  }}"
                   class="bg-gray-200 hover:bg-gray-300 text-black font-bold py-2 px-4 rounded">{{ __('person/edit.back_button') }}</a>
            </div>
