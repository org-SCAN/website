                    ...
                    <div class="shadow overflow-hidden sm:rounded-md">
                        ...
                        <div class="px-4 py-5 bg-white sm:p-6">
                            ...
                            <label for="{{$form_elem}}" class="block font-medium text-md text-gray-700">Event's
                                name</label>
                            <input value="{{ old($form_elem, $event->{$form_elem}) }}" type="text" name="{{$form_elem}}"
                                   id="{{$form_elem}}"
                        ...
                        <div class="px-4 py-5 bg-white sm:p-6">
                            ...
                            <label for="{{$form_elem}}" class="block font-medium text-md text-gray-700">Event's
                                start date</label>
                            <input value="{{ old($form_elem,$event->{$form_elem} ) }}" type="date" name="{{$form_elem}}"
                                   id="{{$form_elem}}"
                                   class="form-input rounded-md shadow-sm mt-1 block w-full"/>
