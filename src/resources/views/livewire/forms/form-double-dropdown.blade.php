<div>
    <div class="mb-8">
        ...
        <select name="parent_list" class="border shadow p-2 bg-white" wire:model.live="selected_parent_id">
    ...
    <div class="mb-8">
        ...
        <select name="childs" class="border shadow p-2 bg-white" wire:model.live="child_id">
