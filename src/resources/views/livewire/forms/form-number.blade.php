<div>
    ...
    <input value="{{ old($form_elem, $previous) }}" type="number" name="{{$form_elem}}" id="{{$form_elem}}"
        class="form-input rounded-md shadow-sm mt-1 block w-full" placeholder="{{$placeHolder}}"/>
