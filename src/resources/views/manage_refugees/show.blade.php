@section('title','View '.$refugee->best_descriptive_value." details")
<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            <b>{{ $refugee->best_descriptive_value }}</b> details
        </h2>
    </x-slot>
    ...
    <div>
        <div class="max-w-6xl mx-auto py-10 sm:px-6 lg:px-8">
            <div class="block mb-8">
                <form action="{{route('manage_refugees.destroy', $refugee->id)}}" method="POST"
                    ...
                    @if(Auth::user()->hasPermission("manage_refugees.edit"))
                        <a href="{{ route('manage_refugees.edit', $refugee->id) }}"
